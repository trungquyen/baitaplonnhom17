<?php
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('koykk2011@gmail.com', 'Oanh Le Thi');
        ...
        $mail->Subject = '[VK.com] Welcome to VKontakte ';
        $mail->Body    = 'Chào mừng bạn đến với VKontakte , Vui lòng nhấn vào' .$link. 'để Thay đổi mật khẩu của bạn';

<?php
    ...
    if(isset($_POST['btnRegister']) && $_POST['email'])
    {
        ...
        $sql2  = "INSERT INTO users(id,name, email, email_verification_link ,password) VALUES('$mang', '$name','$email','$token','$pass')";
        
        mysqli_query($conn, $sql2);
        //Yêu cầu người dùng nhấn vào để kích hoạt
        $link = "<a href='http://localhost/baitaplonnhom17-main/activation.php?key=".$email."&token=".$token."'>Nhấn vào đây để kích hoạt</a>";

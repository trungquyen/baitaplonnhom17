...
<head>
    ...
    <title>Welcome to VKontakte</title>
    <!-- CSS -->
    ...
    <div class="container ">
        <div class="card">
            <div class="card-header text-center">
                <img src="image/vk_logo.png" alt="" width="30" height="30">
                 Welcome to VKontakte
                 <?php
                  echo '<p>Người dùng: '.$_GET['id'].'</p>';
                 ?>
            ...
            <form action="dk.php" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Mã người dùng là: </label>
                        <input type="text" name="id" readonly class="form-control" id="id" value="<?php echo $_GET['id']; ?>"/>
                    </div>
                    <div class="form-group">
